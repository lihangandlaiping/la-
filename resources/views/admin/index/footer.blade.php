...
<script src="{{ asset('') }}/admin/js/hplus.min.js"></script>
<script src="{{ asset('') }}/admin/js/plugins/sweetalert/sweetalert.min.js?t=2"></script>
<script type="text/javascript" src="{{ asset('') }}/admin/js/contabs.min.js"></script>
<script src="{{ asset('') }}/admin/js/plugins/pace/pace.min.js"></script>
<script src="{{ asset('') }}/admin/js/common.js?t=5"></script>
...
<script>
    function updatePass(){
        qls.prompt('输入新密码：',function(str){
            qls.loading();
            $.post('<?php echo url('admin/index/updatePass');?>',{id:'<?php echo ''?>',pass:str},function(data){
                qls.close();
                if(data.code==1)
                {
